...
public class FaqFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ArrayList<String> questionsReponses = new ArrayList<String>(
                Arrays.asList(
                        "Qui peut donner du sang ?", "Toute personne âgée de 18 à 65 ans révolus peut donner du sang. Le don de sang est également autorisé pour toute personne âgée de 66 ans à 70 ans révolus à condition que son dernier don remonte à moins de trois ans. Le premier don de sang doit avoir eu lieu avant le jour du 66ème anniversaire. Avant chaque don, on vérifie que le donneur est en condition pour donner du sang. Le médecin contrôle entre autres le poids qui doit être supérieur à 50 kilos, et la tension artérielle. Le donneur doit également remplir un questionnaire permettant au médecin de s'assurer de son bon état de santé.",
