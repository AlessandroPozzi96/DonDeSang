...
public class InfosFragment extends Fragment {
    ...
    private LinearLayout linearLayout, linearLayout_QuiPeutDonnerSang, linearLayout_butFaq, linearLayout_QuiPeutRecevoirSang, linearLayout_Deroulement;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final ArrayList<String> questionsReponses = getQuestionsReponses();

        linearLayout_QuiPeutDonnerSang = view.findViewById(R.id.linearLayout_QuiPeutDonnerSang);
        linearLayout_butFaq = view.findViewById(R.id.linearLayout_butFaq);
    ...
    public ArrayList<TextView> genererFaq(ArrayList<String> questionsReponses) {
    ...
    public ArrayList<String> getQuestionsReponses() {
        ArrayList<String> questionsReponses = new ArrayList<String>(
                Arrays.asList(
                        ...
                        "Est-ce que cela dure longtemps ?", "Le prélèvement proprement dit dure de 5 à 10 minutes. Compte tenu de l'inscription, de l'examen médical et du temps de repos après le don, il faut prévoir une demi-heure environ.",
    ...
    private class MyButtonListener implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            ...
            linearLayout_butFaq.removeAllViews();
            ...
            switch (v.getId())
            {
                ...
                case R.id.button_FAQ :
                    ...
                    for (TextView textView : genererFaq(getQuestionsReponses())) {
